...
const SharePage = () => {
  ...
  const updateCurrentURL = (social = '', url = '') => {
    ...
    let urlToCopy = url ? `${url}?_cid=${newGtm ? gtm : selectedSocialOption}` : `${selectedUrlOption}?cid=${newGtm ? gtm : selectedSocialOption}`;
  ...
  const handleSubmit = async () => {
    ...
    let urlToCopy = newUrl ? `${newUrl}?_cid=${newGtm ? gtm : selectedSocialOption}` : `${selectedUrlOption}?cid=${newGtm ? gtm : selectedSocialOption}`;
