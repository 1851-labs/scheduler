      ...
      <div className="relative w-full px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-0 bg-red-200"></div>
        <div className="flex w-full flex-col items-center justify-center mt-20">
          <h1 className=" text-center text-4xl font-medium tracking-tighter text-dark lg:text-6xl">
            At 1851 Labs, we've come up with {numIdeas} app ideas
          </h1>
          <button
          ...
          >
            {isLoading ? (
              ...
              <>
                <img src="/logo.svg" width="50" height="50" alt="logo" className="h-5 w-5 md:h-8 md:w-8" />
  ...
  return (
    <div
      ...
      style={{
        opacity: '0.8',
        background:
          'radial-gradient(54.14% 54.14% at 50% 50%, #D9D7F1 35%, rgba(217, 215, 241, 0.16) 100%)',
        filter: 'blur(150px)',
      }}
    />
  );
