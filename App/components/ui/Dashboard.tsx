...
import { Sheet, SheetContent, SheetTrigger, SheetTitle, SheetDescription } from "@/components/shadcn/Sheet"
                ...
                <div className="sticky top-0 flex h-full max-h-screen flex-col gap-2">
                    <div className="flex h-14 items-center justify-between border-b px-4 lg:h-[60px] lg:px-6">
                        <Link href="/" className="flex items-center gap-2 font-semibold">
                            ...
                            />
                            <span className="">App Template</span>
                        </Link>
                    ...
                    <div className="flex-1">
                        <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
                            <Link
                                href="/"
                                className={getLinkClassNames("/home")}
                            >
                    ...
                    <div className="sticky bottom-5 m-5">
                        ...
                        <div className='flex flex-col items-center mt-16'>
                            ...
                            <div className='flex flex-row space-x-3 py-4'>
                                <SocialIcon onClick={() => { posthog.capture('clicked-social', { platform: 'facebook' }) }} style={{ height: 45, width: 45 }} url="https://www.facebook.com/profile.php?id=61562199479506" target="_blank" />
                                <SocialIcon onClick={() => { posthog.capture('clicked-social', { platform: 'twitter' }) }} style={{ height: 45, width: 45 }} url="https://x.com/ComicSpinApp" target="_blank" />
                                <SocialIcon onClick={() => { posthog.capture('clicked-social', { platform: 'reddit' }) }} style={{ height: 45, width: 45 }} url="https://www.reddit.com/r/ComicSpin/" target="_blank" />
                                <SocialIcon onClick={() => { posthog.capture('clicked-social', { platform: 'discord' }) }} style={{ height: 45, width: 45 }} url="https://discord.com/invite/CkT3R7d8G7" target="_blank" />
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex flex-col w-full md:w-[calc(100%-240px)] lg:w-[calc(100%-320px)]">
                <header className="w-full flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6 md:hidden">
                    <Sheet>
                        ...
                        <SheetContent side="left" className="flex flex-col min-h-screen max-h-screen" onOpenAutoFocus={(e) => e.preventDefault()}>
                            <VisuallyHidden.Root>
                                <SheetTitle>
                                    Menu
                                </SheetTitle>
